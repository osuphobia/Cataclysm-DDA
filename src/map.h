...
class map
{
    ...
    public:
        ...
        *  Values roughly correspond to 10% increment chances of success on a given bash, rounded down. -1 means the square is not bashable */
        ...
        std::pair<float, double> shoot( const tripoint_bub_ms &p, projectile &proj, double missed_by, bool hit_items );
        void shoot_item( const tripoint_bub_ms &p, const projectile &proj, float dam );
